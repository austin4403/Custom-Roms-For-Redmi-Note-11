...
fastboot %* flash crclist %~dp0images\crclist.txt || @echo "Flash crclist error" && pause && exit /B 1
fastboot %* flash sparsecrclist %~dp0images\sparsecrclist.txt || @echo "Flash sparsecrclist error" && pause && exit /B 1
...
::fastboot %* flash frp %~dp0\images\frp_zero.img || @echo "Flash frp error" && exit /B 1
...
::fastboot %* flash tee_b %~dp0\images\tee.img || @echo "Flash tee_a error" && exit /B 1
fastboot %* flash logo_ab %~dp0\images\logo.bin || @echo "Flash logo error" && pause && exit /B 1
::fastboot %* flash logo_b %~dp0\images\logo.bin || @echo "Flash logo error" && exit /B 1
::fastboot %* flash super %~dp0\images\super.img || @echo "Flash super error" && exit /B 1
fastboot %* flash userdata %~dp0\images\userdata.img || @echo "Flash userdata error" && pause && exit /B 1
...
fastboot %* oem cdms
fastboot %* oem lks 2>&1 | findstr /r /c:"lks = *1" || fastboot %* oem lock && exit /B 1
