...
## Step 4: Post-Install Setup (GCam and Apps)
...
3. **Always ask if additional apps (like MicroG, Aurora Store, or Magisk)** need to be installed or pushed to the device.
